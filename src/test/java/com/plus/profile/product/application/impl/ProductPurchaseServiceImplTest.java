...
class ProductPurchaseServiceImplTest {
    ...
    class ProductPurchase {
        ...
        void userNotFound() {
            ...
            assertThat(exception.getMessage()).isEqualTo(ProductExceptionCode.USER_NOT_FOUND.getMessage());
        }
        @Test
        ...
        void productNotFound() {
            ...
            assertThat(exception.getMessage()).isEqualTo(ProductExceptionCode.PRODUCT_NOT_FOUND.getMessage());
        }
        ...
        void insufficientPoints() {
            ...
            assertThat(exception.getMessage()).isEqualTo(ProductExceptionCode.NOT_ENOUGH_POINTS.getMessage());
        }
        ...
        void systemError() {
            ...
            assertThat(exception.getMessage()).isEqualTo(ProductExceptionCode.SYSTEM_ERROR.getMessage());
        }
    }
}
