...
CREATE TABLE IF NOT EXISTS USER_POINTS_LOG (
    ...
    INDEX IDX_PAYMENT_USER_COUPON_COUPON_CODE (COUPON_ID),
...
CREATE TABLE IF NOT EXISTS PAYMENT_TRANSACTIONS (
    ...
    INDEX IDX_PAYMENT_TRANSACTION_STATUS (TRANSACTION_STATUS),
...
CREATE TABLE IF NOT EXISTS PAYMENT_USER_COUPONS (
    PAYMENT_USER_COUPON_ID BIGINT NOT NULL AUTO_INCREMENT,
    USERID BINARY(16) NOT NULL,
    COUPON_ID BINARY(16) NOT NULL,
    USER_COUPON_ID BIGINT,
    COUPON_CODE VARCHAR(255) NOT NULL,
    ...
    CREATED_AT DATETIME(6),
    UPDATED_AT DATETIME(6),
    PRIMARY KEY (PAYMENT_USER_COUPON_ID),
